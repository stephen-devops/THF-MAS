...
"""
    ...
    async def _arun(
        ...
        try:
            ...
            # Handle both string and enum values, normalize to lowercase
            anomaly_type_lower = (anomaly_type.value if hasattr(anomaly_type, 'value') else anomaly_type).lower()
            ...
            if anomaly_type_lower in ["threshold", "thresholds"]:
                ...
                # Check for threshold-related keywords first
